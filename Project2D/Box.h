...
public:
	...
	Box(glm::vec2 a_position, glm::vec2 a_velocity,
		float a_rotation, float a_mass, float a_width, float a_height, glm::vec4 a_color);
	~Box();
...
protected:
	...
	// These will store the local x and y axis of the box based on it's angle of rotation
	glm::vec2 m_localX;
	glm::vec2 m_localY;
};